...
const OrderSummary = ({cart,subtotal,shippingFee,orderTotal,setOrderPlaced ,setOrderSummary,setCart}) => {
  ...
  return (
    <section className='flex justify-center items-center bg-black/95 fixed inset-0 z-40'>
        <div className='bg-zinc-100 p-8 w-[600px] rounded-lg border-2 border-zinc-300'>
            ...
            <div>
                ...
                <div className='flex mt-10 gap-x-3'>
                    ...
                    <button className='bg-blue-600 flex-1 py-3 active:bg-blue-700 text-white rounded-lg cursor-pointer' onClick={handlePlaceOrder}>Place Order</button>
                </div>
        </div>
    </section>
  )
